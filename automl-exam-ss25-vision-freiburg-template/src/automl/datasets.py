...
class SkinCancerDataset(BaseVisionDataset):
    ...
    This dataset contains images of skin lesions. The task is to classify what kind of skin lesion it is.
    The dataset contains 7 classes of skin lesions for dermatological diagnosis.
    """
